...
namespace XLua.CSObjectWrap
{
    ...
    public class AssetLoaderManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(AssetLoaderManager);
        ...
        {
            return LuaAPI.luaL_error(L, "AssetLoaderManager does not have a constructor!");
        }
