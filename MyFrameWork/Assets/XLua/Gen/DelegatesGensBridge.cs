...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp4(ListViewCell p0, int p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp15(string p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new ListViewSimpleDelegate.NumberOfCellsDelegate(__Gen_Delegate_Imp3);
			}
		
		    if (type == typeof(ListViewSimpleDelegate.CellRefreshDelegate))
			{
			    return new ListViewSimpleDelegate.CellRefreshDelegate(__Gen_Delegate_Imp4);
			}
		
		    if (type == typeof(ListViewSimpleDelegate.CellSizeDelegate))
			{
			    return new ListViewSimpleDelegate.CellSizeDelegate(__Gen_Delegate_Imp5);
			}
			...
			{
			    return new System.Action<string>(__Gen_Delegate_Imp15);
			}
