...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public InvokeLua.ICalc __Gen_Delegate_Imp7(int p0, string[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp16(string p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp17(double p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp18(int p0, string p1, out CSCallLua.DClass p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string __Gen_Delegate_Imp28(StructTest p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp29(StructTest p0, object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<UnityEngine.GameObject>(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(System.Action<UIVariable>))
			{
			    return new System.Action<UIVariable>(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Vector2>))
			{
			    return new System.Action<UnityEngine.Vector2>(__Gen_Delegate_Imp3);
			}
		
		    if (type == typeof(ListViewSimpleDelegate.NumberOfCellsDelegate))
			{
			    return new ListViewSimpleDelegate.NumberOfCellsDelegate(__Gen_Delegate_Imp4);
			}
		
		    if (type == typeof(ListViewSimpleDelegate.CellRefreshDelegate))
			{
			    return new ListViewSimpleDelegate.CellRefreshDelegate(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(ListViewSimpleDelegate.CellSizeDelegate))
			{
			    return new ListViewSimpleDelegate.CellSizeDelegate(__Gen_Delegate_Imp6);
			}
			...
			{
			    return new InvokeLua.CalcNew(__Gen_Delegate_Imp7);
			}
			...
			{
			    return new System.Action<string>(__Gen_Delegate_Imp16);
			}
		
		    if (type == typeof(System.Action<double>))
			{
			    return new System.Action<double>(__Gen_Delegate_Imp17);
			}
		
		    if (type == typeof(CSCallLua.FDelegate))
			{
			    return new CSCallLua.FDelegate(__Gen_Delegate_Imp18);
			}
		
		    if (type == typeof(CSCallLua.GetE))
			{
			    return new CSCallLua.GetE(__Gen_Delegate_Imp19);
			}
