...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp6(ListViewCell p0, int p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public InvokeLua.ICalc __Gen_Delegate_Imp8(int p0, string[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp15(HotfixCalc p0, int p1, out double p2, ref string p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public double __Gen_Delegate_Imp16(double p0, double p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(SignalDelegate))
			{
			    return new SignalDelegate(__Gen_Delegate_Imp4);
			}
		
		    if (type == typeof(ListViewSimpleDelegate.NumberOfCellsDelegate))
			{
			    return new ListViewSimpleDelegate.NumberOfCellsDelegate(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(ListViewSimpleDelegate.CellRefreshDelegate))
			{
			    return new ListViewSimpleDelegate.CellRefreshDelegate(__Gen_Delegate_Imp6);
			}
		
		    if (type == typeof(ListViewSimpleDelegate.CellSizeDelegate))
			{
			    return new ListViewSimpleDelegate.CellSizeDelegate(__Gen_Delegate_Imp7);
			}
			...
			{
			    return new InvokeLua.CalcNew(__Gen_Delegate_Imp8);
			}
			...
			{
			    return new TestOutDelegate(__Gen_Delegate_Imp15);
			}
		
		    if (type == typeof(System.Func<double, double, double>))
			{
			    return new System.Func<double, double, double>(__Gen_Delegate_Imp16);
			}
