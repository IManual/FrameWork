...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTransformWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "FindHard", _m_FindHard);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "LookPosition", _m_LookPosition);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "LookDirection", _m_LookDirection);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "CalculateAroundObjects", _m_CalculateAroundObjects);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_FindHard(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.Transform gen_ret = gen_to_be_invoked.FindHard( _path );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_LookPosition(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    ...
                    gen_to_be_invoked.LookPosition( _targetPos );
                ...
                {
                    UnityEngine.Vector3 _targetPos;translator.Get(L, 2, out _targetPos);
                    float _rotateSpeed = (float)LuaAPI.lua_tonumber(L, 3);
                    
                    gen_to_be_invoked.LookPosition( _targetPos, _rotateSpeed );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.LookPosition!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_LookDirection(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    UnityEngine.Vector3 _targetDir;translator.Get(L, 2, out _targetDir);
                    
                    gen_to_be_invoked.LookDirection( _targetDir );
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    gen_to_be_invoked.LookDirection( _targetDir, _rotateSpeed );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.LookDirection!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_CalculateAroundObjects(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    float _angle = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        UnityEngine.Transform[] gen_ret = gen_to_be_invoked.CalculateAroundObjects( _tags, _distance, _angle );
                        translator.Push(L, gen_ret);
