...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIToggleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "AddValueChangedListener", _m_AddValueChangedListener);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_AddValueChangedListener(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.AddValueChangedListener( _call );
