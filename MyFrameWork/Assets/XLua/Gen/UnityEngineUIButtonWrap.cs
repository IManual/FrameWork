...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIButtonWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetClickListener", _m_SetClickListener);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetClickListener(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetClickListener( _callback );
